...
DIV = GeneratedImages{3}; % division between training and test tests
DIM1 = GeneratedImages{4}; % number of training patterns
DIM2 = GeneratedImages{5}; % number of total patterns
yE = GeneratedImages{2}; % labels of patterns
